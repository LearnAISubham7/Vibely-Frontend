...
export function ChannelProfile() {
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        // console.log(username + "Current user data:" + response.data);
        ...
        <div className=" flex">
          ...
          <div className=" ml-2">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              @{profileUser.data.username} • 120K subscribers
            </p>
            <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            {isMyProfile ? (
              ...
              <button className="px-4 mt-2 py-2 bg-red-600 text-white rounded-lg cursor-pointer">
                Subscribe
              </button>
            )}
          </div>
